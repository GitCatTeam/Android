...
import kotlinx.android.synthetic.main.fragment_choose_cat1.*

private const val ARG_PARAM1 = "param1"
private const val ARG_PARAM2 = "param2"

class ChooseCat1Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_choose_cat1, container, false)

        //FIXME: 투명도 주기
//        val cat1D = cat1.compoundDrawables
//        cat1D[0].alpha = 50
        //TODO: 물음표 이미지랑 NEW 이미지 붙이기
