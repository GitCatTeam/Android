...
class SettingsFragment : PreferenceFragmentCompat() {
    ...
    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        ...
        val set_feedback = findPreference("etc_feedback") as Preference
        ...
        set_repo.setOnPreferenceClickListener {
            ...
            dialogMessage.text =
                getString(R.string.settings_popup_repo2) + " " + settings.getString(
                    "repoAuth",
                    ""
                ) + " " + getString(R.string.settings_popup_repo3)
            ...
            dialogOK.setOnClickListener {
                ...
                val call2: Call<DeviceIdModel> =
                    RetrofitCreator.service.deleteDeviceToken(settings.getString("token", "")!!, ai)
                call2.enqueue(
                ...
                val call: Call<LogoutModel> =
                    RetrofitCreator.service.postLogout(settings.getString("token", "")!!)
                call.enqueue(
        ...
        set_cat.setOnPreferenceClickListener {
            ...
            dialogOK.setOnClickListener {
                NewToken(context!!)
                val call: Call<Unit> =
                    RetrofitCreator.service.deleteCats(settings.getString("token", "")!!)
                call.enqueue(
        ...
        set_feedback.setOnPreferenceClickListener {
            val email = Intent(Intent.ACTION_SEND)
            email.type = "plain/Text"
            val gitcatemail: Array<String> = arrayOf("gitcatlove@gmail.com")
            email.putExtra(Intent.EXTRA_EMAIL, gitcatemail)
//            email.putExtra(
